...
type SearchOrganizationsScrollerProps = {
...
export const SearchOrganizationsScroller: FC<SearchOrganizationsScrollerProps> = ({
  ...
  const {
    ...
    fetchData: (page) => searchOrganizations(search, page),
  })
      ...
      {match(status)
        ...
        .with('error', () => (
          <div className="flex flex-col gap-y-2 w-full items-center justify-center py-4">
            <p className="text-muted-foreground">団体の取得に失敗しました</p>
