...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: this code is generated by shadcn/ui
...
>(
  (
    ...
    // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: this code is generated by shadcn/ui
